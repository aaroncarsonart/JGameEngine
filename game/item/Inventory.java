 ...
 * are up to the implementing classes.  (For instance, more complex behavior
 * can be implemented by allowing more than one item to occupy each slot).
 * @author Aaron Carson
 * @version Jul 23, 2015
 */
...
{	
	 ...
	 * Inventory. (If this amount were added, it would cause the Inventory
	 * to become full).
	...
	/**
	 * Get a string description of the contents of this Inventory.
	 * @return A string description.
	 */
	String getContents();
	
	/**
	 * Get a string description of each slot of the inventory.
	 * @return A string array.
	 */
	String[] getSlotDescriptions();
	...
	public static void test(Inventory<Item> inventory){
		...
		System.out.printf("Created new: %s\n", item4);
		System.out.printf("Created new: %s\n", item5);
		System.out.printf("count( %-12s): %d\n", item1.name, inventory.count(item1));
		System.out.printf("count( %-12s): %d\n", item2.name, inventory.count(item2));
		System.out.printf("count( %-12s): %d\n", item3.name, inventory.count(item3));
		System.out.printf("count( %-12s): %d\n", item4.name, inventory.count(item4));
		System.out.printf("count( %-12s): %d\n", item5.name, inventory.count(item5));
		inventory.add(item1);
		...
		System.out.printf("withinBounds(%2d ): %b\n", -1, inventory.withinBounds(-1));
		System.out.printf("withinBounds(%2d ): %b\n", 0, inventory.withinBounds(0));
		System.out.printf("withinBounds(%2d ): %b\n", 1, inventory.withinBounds(1));
		System.out.printf("withinBounds(%2d ): %b\n", 5, inventory.withinBounds(5));
		System.out.printf("withinBounds(%2d ): %b\n", 9, inventory.withinBounds(9));
		System.out.printf("withinBounds(%2d ): %b\n", 10, inventory.withinBounds(10));
