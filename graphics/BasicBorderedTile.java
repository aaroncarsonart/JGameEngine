 ...
 * @version Jul 20, 2015
 */
public class BasicBorderedTile
{
	 ...
	 * @param center
	 */
	public BasicBorderedTile(BufferedImage src, byte cellType) {
		this.tiles_16 = new SpriteSheet(src, T_SIZE_16, T_WIDTH_16, T_HEIGHT_16);
		this.tiles_8 = new SpriteSheet(src, T_SIZE_8, T_WIDTH_8, T_HEIGHT_8);
