...
/**
 * The Position class, used to hold x/y positional int data.
 *
 * @author Aaron Carson
 * @version 1.0
 */
public final class Position implements Serializable
{
	...
	private static final long		serialVersionUID	= 0001_0001L;
	...
	/**
	 * Move this Position in one of the four cardinal directions according to
	 * the input value, which is dependent on the remainder of absolute value of
	 * next when divided by four. The associations are: (0 :: up, 1 :: down, 2
	 * :: left, 3 :: right).
	 * 
	...
	public boolean isAdjacentAbove(Position checkPos) {
		return this.x == checkPos.x && (this.y - 1) == checkPos.y;
	}
	...
	public boolean isAdjacentLeft(Position checkPos) {
		return (this.x - 1) == checkPos.x && this.y == checkPos.y;
	}
	 ...
	 * @return A new Position, oriented from the original Position by the input
	 *         Direction.
	 */
	...
	/**
	 * Print these coordinates in a easily readable fashion.
	 */
	@Override
